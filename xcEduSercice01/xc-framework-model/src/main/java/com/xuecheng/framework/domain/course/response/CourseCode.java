...
public enum CourseCode implements ResultCode {
    ...
    COURSE_GET_NOTEXISTS(false, 31103, "选择的媒资文件不存在！"),
    COURSE_PUBLISH_CREATE_INDEX_ERROR(false, 31104, "课程索引信息创建失败！"),
    COURSE_MEDIA_TEACHPLAN_ISNULL(false, 31105, "所查询课程计划为空！"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false, 31106, "该所选节点非叶子结点！");
